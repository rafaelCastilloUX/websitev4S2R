                              ...
                              <div class="col-12 col-lg-8 offset-lg-2 pb-4 pb-md-0">
                                  <form  class="row row-cols-lg-auto g-2 align-items-center overflow-hidden rounded-1 p-2 bg-white">
                                      <div class="col-12 col-lg-7 col-xl-8 p-2 mt-0">
                                        ...
                                        <div class="form-control form-control-lg border-0 batch-loading">
                                          <input class="batch-autocomplete" id="batchAddressAutoComplete" notFoundText="No results found"
                                            showNotFound=true displayData="name" type="text" take='5' debounce='700'
                                            placeholder="Enter your address to see if Sell2Rent's program is right for you."
                                            filterType="address">
                                      ...
                                      <div class="col-12 col-lg-5 col-xl-4  mt-0 ">
                                        <button onclick="goToForms()" type="button" class="btn btn-verde btn-lg w-100 fw-bold py-3 fs-5">GET STARTED <i class="fa-solid fa-chevron-right"></i></button>
                                      </div>
                                    </form>
                              </div><!--/col-->
                            </div><!--/.row-->
