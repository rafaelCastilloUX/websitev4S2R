            ...
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-md-2 align-items-center">
                    ...
                    <div class="col order-1 order-md-2">
                        <img src="img/vision.png" alt="Our Vision" class="img-fluid">
                    </div><!--/.col-->
                </div><!--/.row-->
            </div><!--/.container -->
        </section><!--/my-5 -->
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <div class="tab-pane fade" id="crm-tab-pane" role="tabpanel" aria-labelledby="crm-tab" tabindex="0">... crm  ppl </div>
                        <div class="tab-pane fade" id="operations-tab-pane" role="tabpanel" aria-labelledby="operations-tab" tabindex="0">...operations ppl </div>
                        <div class="tab-pane fade" id="human-tab-pane" role="tabpanel" aria-labelledby="human-tab" tabindex="0">... human ppl </div>
                        </div>
                    </div><!--/col-->
                </div><!--/row-->
            </div><!--/container-->
            <div class="container">
                ...
                <div class="row">
                    <div class="col text-center">
                        <img src="img/mp-XL.png" alt="MAP CONECCTIONS" class="img-fluid">
                    </div><!--/.col-->
                </div><!--/.row-->
                <!---->
