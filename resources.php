                ...
                <div class="row text-center " >
                    <div class="col">
                        <div class="p-5 text-center rounded-2 text-white top-xl-25vh w-100"  >
                            ...
                            <h1 class="fw-bold text-white display-4">Resources, and More!</h1>  
                        </div>
                    </div><!--/col-->
                </div><!--/row-->
            </div><!--/container-->
            ...
            <div class="row">
              <div class="col">
                <form class="d-flex g-3">
                  ...
                  <button class="btn btn-verde me-2" type="submit">GO</button>              
                </form>
              </div>
            </div>
          </div><!--/container-->
            ...
            <div class="row row-cols-1 row-cols-md-2">
              <div class="col">
                <div class="card text-white bg-navy mb-3">
                  <img src="img/resources_demo1.png" class="card-img-top" alt="Photos">
                  <div class="card-body p-md-5"> 
                    <div class="d-inline">
                      <span class="badge text-bg-dark">White Paper</span>
                      <span class="badge text-bg-dark">June 30, 2023</span>
                    </div><!--/inline-->
                      <p class="card-text fs-5">We see a short window of opportunity to invest in European real estate for value.</p>
                  </div><!--/card-body-->
                </div><!--/card-->
              </div><!--/col-->
              <div class="col">
          ...
          <div class="container">
            <div class="row row-cols-1 row-cols-md-2 d-flex justify-content-between align-items-center">
              <div class="col col-md-8 col-lg-10 text-center text-md-start">
                <h2 class="fw-bold display-5">Must Reads for you</h2>
            ...
            <div class="row row-cols-1 row-cols-md-3 ">
              <div class="col mb-2">
                <div class="card" >
                  <img src="img/resources_democard1.png" class="card-img-top" alt="...">
                  <div class="card-body">
              ...
              <div class="col mb-2">
                <div class="card" >
                  <img src="img/resources_democard2.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title fw-bold">Chasing out : home equity to pay off debt </h5>
                    <p class="card-text">Introduction: Life can be unpredictable, throwing unexpected challenges our way. When it comes to homeownership, sometimes selling your house and renting it back can be.</p>
                    <a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="#"> READ MORE <i class="fa-solid fa-angles-right"></i></a>                 
              ...
              <div class="col mb-2">
                <div class="card" >
                  <img src="img/resources_democard3.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title fw-bold">Chasing out : home equity to pay off debt </h5>
                    <p class="card-text">Introduction: Life can be unpredictable, throwing unexpected challenges our way. When it comes to homeownership, sometimes selling your house and renting it back can be.</p>
                    <a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="#"> READ MORE <i class="fa-solid fa-angles-right"></i></a>                 
